...
public class NoConectivityDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage("Não foi possível realizar esta operação. Por favor, cheque sua conectividade com a Internet.");
